...
@property (nonatomic, copy, nullable) NSString *filePath;       // 文件名（相册中不可直接访问）
@property (nonatomic, assign) long long fileSize;               // 文件大小
@property (nonatomic, assign) float duration;                   // 录制时长
@property (nonatomic, copy, nullable) NSString *fileMd5;        // 相册资源的MD5
@property (nonatomic, copy, nullable) NSString *assetLocalId;   // PHAsset.localIdentifier
